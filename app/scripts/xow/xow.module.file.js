...
(function (factory) {
  ...
  XoW.FileManager = function (globalManager) {
    ...
    this.downLoadFile = function (pSid, pJid) {
      ...
      download("data:" + file.mime + ";base64," + file.base64, file.filename, file.mime);
    ...
    var _onSiReqRcv = function (params) {
      ...
      theFile.filename = params.filename;
    ...
    var _onIBBRcv = function (type, pJid, pSid, data, pSeq, blocksize) {
      ...
      switch (type) {
        ...
        case 'data':
          ...
          if (null != file) {
            ...
            if (parseInt(pSeq) === fileSeq) {
              ...
              file.seq = fileSeq;
	            file.sizeRecved = file.sizeRecved || 0;
        ...
        case 'close':
          ...
          } else if (resize >= size || file.sizeRecved >= size) {
